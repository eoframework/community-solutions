...
networking = {
  ...
  subnet_private_az1_cidr = "10.1.0.0/24"
  # Private subnet CIDR in AZ2 hosting Lambda and AgentCore
  subnet_private_az2_cidr = "10.1.1.0/24"
  # Private subnet CIDR in AZ3 hosting Lambda and AgentCore
  subnet_private_az3_cidr = "10.1.2.0/24"
  subnet_public_cidr = "10.1.100.0/24"  # Public subnet CIDR hosting NAT Gateway
