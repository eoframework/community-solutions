...
cognito = {
  ...
  user_pool_name = "amatra-dev-user-pool"
}

secrets = {
  # Secrets Manager secret name holding the Cognito App Client secret
  manager_cognito_secret_name = "amatra/dev/cognito-app-client-secret"
  # Secrets Manager secret name holding the GitHub PAT
  manager_github_pat_secret_name = "amatra/dev/github-pat"
}
