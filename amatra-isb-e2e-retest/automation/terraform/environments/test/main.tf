#------------------------------------------------------------------------------
# AWS Agentic Pre-Sales Orchestration Platform — Test Environment
# EO Framework | Solution: aws-agentic-presales | Environment: dev
#------------------------------------------------------------------------------

locals {
  environment = "test"
  name_prefix = "eofw-dev"
...
#===============================================================================
# OPERATIONS — Monitoring (lightweight for test)
#===============================================================================
...
module "monitoring" {
  ...
  # S3 data events disabled in test to reduce cost
