#------------------------------------------------------------------------------
# ANP Streaming AI Recommendation Engine — DR Environment
# Mirrors production sizing; standby warm-mode; GuardDuty/WAF managed at prod
#------------------------------------------------------------------------------
...
module "security" {
  ...
  # WAF and GuardDuty are managed at prod for DR environment
  waf_enabled                       = false
...
#===============================================================================
# OPERATIONS — Monitoring, alerting, and compliance
#===============================================================================
...
# SQS DLQ message count alarm — links monitoring SNS to messaging DLQ metric
