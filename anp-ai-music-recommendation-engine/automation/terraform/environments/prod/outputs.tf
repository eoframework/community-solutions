#------------------------------------------------------------------------------
# ANP Streaming AI Recommendation Engine — Production Outputs
#------------------------------------------------------------------------------
...
output "api_gateway_endpoint" {
  description = "Base URL of the production API Gateway endpoint"
...
output "api_gateway_stage_arn" {
  description = "ARN of the deployed API Gateway stage (used for WAF association)"
...
output "waf_web_acl_arn" {
  description = "WAF Web ACL ARN associated with the API Gateway"
...
output "opensearch_endpoint" {
  description = "OpenSearch Service domain endpoint for semantic catalog search"
...
output "private_subnet_app_ids" {
  description = "IDs of the private application subnets for Lambda and SageMaker ENIs"
  value       = module.networking.private_subnet_app_ids
}

output "private_subnet_data_ids" {
  description = "IDs of the private data subnets for OpenSearch and ElastiCache nodes"
  value       = module.networking.private_subnet_data_ids
}

output "app_security_group_id" {
  description = "Security group ID assigned to Lambda and application-tier resources"
...
output "interaction_events_table_arn" {
  description = "DynamoDB table ARN for interaction event capture"
  value       = module.database.interaction_events_table_arn
}

output "mood_taxonomy_table_arn" {
  description = "DynamoDB table ARN for canonical mood taxonomy reference data"
  value       = module.database.mood_taxonomy_table_arn
}
