...
database = {
  ...
  content_catalog_table = "anp-dev-content-catalog"
  # DynamoDB table for play/skip/like/dislike feedback events; primary retraining input
  interaction_events_table = "anp-dev-interaction-events"
