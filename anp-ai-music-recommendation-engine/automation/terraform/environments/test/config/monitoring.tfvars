...
monitoring = {
  ...
  cloudwatch_dashboard_api = "anp-dev-api-health"
  # CloudWatch dashboard name covering business KPI metrics
  cloudwatch_dashboard_business = "anp-dev-business-metrics"
  # CloudWatch dashboard name covering ML pipeline metrics
  cloudwatch_dashboard_ml = "anp-dev-ml-pipeline"
