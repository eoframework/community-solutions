...
storage = {
  ...
  s3_cloudtrail_bucket = "[anp-dev-cloudtrail]"  # TODO: Replace with actual value
  # S3 bucket for computed audio feature vectors at the features prefix
  s3_features_bucket = "[anp-dev-features]"  # TODO: Replace with actual value
  ...
  s3_models_bucket = "[anp-dev-models]"  # TODO: Replace with actual value
  # S3 bucket for source audio files stored at the raw-catalog prefix
  s3_raw_catalog_bucket = "[anp-dev-raw-catalog]"  # TODO: Replace with actual value
  # S3 bucket for lyric and podcast transcript text files
  s3_transcripts_bucket = "[anp-dev-transcripts]"  # TODO: Replace with actual value
