#------------------------------------------------------------------------------
# ANP Streaming AI Recommendation Engine — Test Outputs
#------------------------------------------------------------------------------

output "vpc_id" {
  description = "VPC identifier for the test environment"
  value       = module.networking.vpc_id
}

output "api_gateway_endpoint" {
  description = "Base URL of the test API Gateway endpoint"
