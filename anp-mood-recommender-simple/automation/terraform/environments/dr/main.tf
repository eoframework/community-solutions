#------------------------------------------------------------------------------
# ANP Streaming AI - DR Environment
# DR mirrors production sizing; PITR-enabled tables provide the RPO target.
# IaC re-deployment from this env achieves the 1-hour RTO.
#------------------------------------------------------------------------------
