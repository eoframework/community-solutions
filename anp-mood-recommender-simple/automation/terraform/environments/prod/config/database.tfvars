...
database = {
  ...
  catalog_moods_pitr_enabled = true
  # DynamoDB table name for the catalog mood-tag index
  catalog_moods_table_name = "anp-catalog-moods-prod"
  ...
  user_history_pitr_enabled = true
  # DynamoDB table name for per-user listening history records
  user_history_table_name = "anp-user-history-prod"
