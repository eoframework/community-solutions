...
storage = {
  ...
  log_archive_bucket_name_primary = "[log-archive-s3-bucket-use2]"  # TODO: Replace with actual value
  # CRR destination S3 bucket name in us-east-2 for log archive cross-region replication
  log_archive_bucket_name_replica = "[log-archive-s3-bucket-use1]"  # TODO: Replace with actual value
  # Days after which Log Archive objects transition from S3 Standard to Glacier Instant Retrieval
  log_archive_glacier_transition_days = 90
