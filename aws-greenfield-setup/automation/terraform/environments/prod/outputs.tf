...
output "security_kms_key_arn_primary" {
  description = "ARN of the primary region customer-managed KMS key"
...
output "logging_cloudtrail_lake_event_store_arn" {
  description = "ARN of the CloudTrail Lake event data store"
  value       = module.logging.cloudtrail_lake_event_store_arn
}
...
output "name_prefix" {
  description = "Resource naming prefix used across the landing zone"
