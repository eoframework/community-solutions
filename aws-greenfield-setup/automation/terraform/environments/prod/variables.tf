...
# Values are injected from config/*.tfvars by the orchestrator
#------------------------------------------------------------------------------

#------------------------------------------------------------------------------
# Project / Solution identity
#------------------------------------------------------------------------------
variable "solution" {
...
#------------------------------------------------------------------------------
# AWS account and Organizations identifiers
# These values carry Security Level = Confidential; never hard-code
# — injected from Secrets Manager / SSM at runtime
#------------------------------------------------------------------------------
variable "aws_accounts" {
  description = "AWS account IDs for all landing zone accounts (sourced from Secrets Manager)"
  type = object({
