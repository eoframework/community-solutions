...
networking = {
  ...
  firewall_policy_arn_us_east_1 = "[nfw-policy-arn-use1]"  # TODO: Replace with actual value
  # ARN of the AWS Network Firewall stateful policy in us-east-2
  firewall_policy_arn_us_east_2 = "[nfw-policy-arn-use2]"  # TODO: Replace with actual value
  # Network Hub VPC CIDR block in us-east-1; must not be allocated from the spoke IPAM pool
  hub_vpc_us_east_1_cidr = "10.128.0.0/20"
  # Network Hub VPC CIDR block in us-east-2; mirrors hub layout with a different offset
  hub_vpc_us_east_2_cidr = "10.192.0.0/20"
  ...
  nat_gateway_count_per_region = 1
