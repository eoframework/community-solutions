#------------------------------------------------------------------------------
# AWS Multi-Account Landing Zone — Test Environment
# Provider: AWS | Region: us-east-1 | Environment: nonprod
# Note: Reduced guardrails (no RCP data perimeter), single NAT, shorter retention
#------------------------------------------------------------------------------
...
locals {
  ...
  # SCP documents — same deny_root, restrict_regions, lock_cloudtrail, lock_config
  # No RCP data perimeter in test (reduces friction per configuration.csv)
...
#===============================================================================
# FOUNDATION — Core governance and security primitives (Test: no RCP)
#===============================================================================
module "governance" {
...
#===============================================================================
# CORE SOLUTION — Logging (shorter retention for test)
#===============================================================================
module "logging" {
...
#===============================================================================
# OPERATIONS — Monitoring, alerting (reduced cost for test)
#===============================================================================
module "monitoring" {
