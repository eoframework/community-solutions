#------------------------------------------------------------------------------
# Ml Platform Configuration - PROD Environment
#------------------------------------------------------------------------------
...
ml = {
  ...
  inference_sagemaker_latency_budget_ms = 1500
  ...
  inference_volume_monthly = 10000000
  ...
  kinesis_stream_name = "medcore-cds-prod-events"
  ...
  msk_cluster_name = "medcore-cds-prod-kafka"
