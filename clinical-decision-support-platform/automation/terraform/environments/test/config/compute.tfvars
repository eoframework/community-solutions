...
compute = {
  ...
  ecs_cluster_name = "medcore-cds-qa-cluster"
  ...
  lambda_alert_router_memory_mb = 256
  # Memory in MB for Epic FHIR R4 connector Lambda function
  lambda_fhir_connector_memory_mb = 512
  ...
  lambda_hl7_adapter_memory_mb = 512
