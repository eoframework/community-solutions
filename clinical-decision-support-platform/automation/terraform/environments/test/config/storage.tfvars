...
storage = {
  ...
  healthlake_active_storage_tb = "0.1"
  ...
  healthlake_retention_years = 1
  # Amazon Redshift cluster identifier for longitudinal outcomes warehouse
  redshift_cluster_identifier = "medcore-cds-qa-redshift"
  ...
  s3_cross_region_replication_enabled = false
  ...
  s3_object_lock_retention_years = 0
}
