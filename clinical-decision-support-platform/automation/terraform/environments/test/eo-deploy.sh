#!/usr/bin/env bash
# MedCore CDS Platform — Test Environment Deployment Wrapper
# See environments/prod/eo-deploy.sh for full documentation.
...
case "$COMMAND" in
  ...
  "destroy")
    echo -e "${RED}⚠️  Destroying ${ENVIRONMENT} infrastructure${NC}"; build_var_files; terraform destroy $VAR_FILES "$@" ;;
