...
database = {
  ...
  dynamodb_global_quota_table_name = "amatra-prod-ddb-global-quota"
  ...
  dynamodb_solutions_table_name = "amatra-prod-ddb-solutions"
  # DynamoDB Users table name storing user profiles and per-user monthly quota counters
  dynamodb_users_table_name = "amatra-prod-ddb-users"
}
