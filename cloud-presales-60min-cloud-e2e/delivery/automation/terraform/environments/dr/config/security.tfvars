...
security = {
  ...
  cloudtrail_s3_bucket_name = "amatra-prod-s3-cloudtrail-logs-[aws-account-id]"
  ...
  cognito_user_pool_name = "amatra-prod-cognito-userpool"
  ...
  secrets_github_pat_secret_name = "amatra/prod/github/pat"
