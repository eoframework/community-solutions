...
# DR Deployment wrapper script — Linux/Mac
...
echo -e "${BLUE}🚀 Amatra — DR Environment — Terraform Wrapper${NC}"
echo -e "${CYAN}═══════════════════════════════════════════════════════════${NC}"
echo -e "${RED}⚠️  DISASTER RECOVERY ENVIRONMENT — deploy after prod${NC}"
echo -e "${CYAN}═══════════════════════════════════════════════════════════${NC}"
...
case $COMMAND in
  ...
  "destroy")
    build_var_files
    echo -e "${RED}⚠️  Destroying DR infrastructure...${NC}"
    # shellcheck disable=SC2086
