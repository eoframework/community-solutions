#------------------------------------------------------------------------------
# Amatra Agentic Orchestration Platform — Production Outputs
#------------------------------------------------------------------------------
...
output "waf_web_acl_arn" {
  description = "WAF WebACL ARN associated with API Gateway"
