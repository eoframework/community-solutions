...
compute = {
  ...
  agentcore_max_concurrency_per_agent = 5
  ...
  lambda_github_integration_concurrency_limit = 10
  ...
  lambda_solution_create_concurrency_limit = 20
  ...
  lambda_solution_create_provisioned_concurrency = 0
