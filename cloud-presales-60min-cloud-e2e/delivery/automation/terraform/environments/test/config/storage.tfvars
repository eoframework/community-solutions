...
storage = {
  ...
  ecr_repository_name = "amatra-dev-ecr-eoframework-agent"
  # S3 bucket name for raw MD/CSV source artifacts and converted DOCX/PPTX/XLSX artifacts
  s3_artifacts_bucket_name = "amatra-dev-s3-artifacts-[aws-account-id]"
  ...
  s3_guidance_bucket_name = "amatra-dev-s3-guidance-[aws-account-id]"
