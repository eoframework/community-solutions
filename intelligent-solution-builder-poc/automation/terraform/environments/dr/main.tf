###############################################################################
# Amatra Intelligent Solution Builder — DR Environment (us-east-1)
# Warm-standby: S3 cross-region replication destination,
# full Lambda + Step Functions stack ready for failover activation.
# WAF disabled (managed at prod); PITR enabled; DynamoDB restored from PITR.
###############################################################################
...
#===============================================================================
# FOUNDATION — DR region foundational infrastructure
#===============================================================================
module "security" {
  source      = "../../modules/security"
  name_prefix = local.name_prefix
  # WAF managed at production; disabled in DR
...
#===============================================================================
# CORE SOLUTION — DR data stores and compute (warm standby)
#===============================================================================
module "storage" {
  ...
  # DR bucket receives replication from prod — not the initiator
...
#===============================================================================
# OPERATIONS — Independent audit trail for DR region
#===============================================================================
module "monitoring" {
...
# WAF association (disabled in DR by default via variable)
