...
#===============================================================================
# CORE SOLUTION — Storage, Identity, Compute, and API
#===============================================================================
module "storage" {
  ...
  enable_s3_replication      = var.storage.enable_s3_replication
  s3_replication_role_arn    = var.storage.s3_replication_role_arn
  dr_replication_bucket_arn  = var.storage.dr_replication_bucket_arn
  dr_replication_kms_key_arn = var.storage.dr_replication_kms_key_arn
  force_destroy              = false
...
#===============================================================================
# OPERATIONS — Monitoring, observability, and CloudTrail audit
#===============================================================================
module "monitoring" {
