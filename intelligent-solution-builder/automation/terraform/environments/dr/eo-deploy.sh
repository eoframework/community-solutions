#!/bin/bash
# Amatra ISB — DR Environment Terraform Deployment Script
...
echo -e "${BLUE}🚀 Amatra ISB — DR Environment Deployment${NC}"
echo -e "${CYAN}═══════════════════════════════════════════════════════${NC}"
echo -e "${YELLOW}⚠️  DR environment — warm standby for RPO ≤15min / RTO ≤1hr${NC}"
echo -e "${CYAN}═══════════════════════════════════════════════════════${NC}"
