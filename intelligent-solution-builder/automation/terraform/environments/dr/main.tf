#------------------------------------------------------------------------------
# Amatra Intelligent Solution Builder — DR Environment
# Warm standby for RPO ≤15 min / RTO ≤1 hour recovery targets
# Region: us-west-2 | WAF/GuardDuty managed at prod
#------------------------------------------------------------------------------
...
#===============================================================================
# FOUNDATION — Encryption keys (WAF/GuardDuty managed at prod)
#===============================================================================
module "kms" {
...
#===============================================================================
# CORE SOLUTION — Full DR platform (matches prod sizing for warm standby)
#===============================================================================
module "storage" {
...
#===============================================================================
# OPERATIONS — Monitoring and CloudTrail (independent audit trail for DR)
#===============================================================================
module "monitoring" {
...
resource "aws_cloudwatch_metric_alarm" "dlq_depth" {
  ...
  alarm_description   = "P1: DLQ message received — DR generation job failed after max retries"
