...
storage = {
  ...
  s3_artifacts_bucket_name = "[amatra-isb-artifacts-dev-account-id]"  # TODO: Replace with actual value
  # Days before artifacts are transitioned from S3 Standard to S3 Glacier Flexible Retrieval
  s3_artifacts_lifecycle_standard_days = 30
  # S3 bucket name for immutable CloudTrail audit logs with Object Lock (WORM)
  s3_cloudtrail_bucket_name = "[amatra-isb-cloudtrail-logs-dev]"  # TODO: Replace with actual value
  ...
  s3_templates_bucket_name = "[amatra-isb-templates-dev]"  # TODO: Replace with actual value
